...
public class StringUtil {
	...
	/**  
     * Email正则表达�?=^\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*$  
     */  
    public static final String EMAIL = "^\\w+([-+.]\\w+)*@\\w+([-.]\\w+)*\\.\\w+([-.]\\w+)*$";   
       
    /**  
     * 电话号码正则表达�?= (^(\d{2,4}[-_－�?�]?)?\d{3,8}([-_－�?�]?\d{3,8})?([-_－�?�]?\d{1,7})?$)|(^0?1[35]\d{9}$)   
     */  
    public static final String PHONE = "(^(\\d{2,4}[-_－�?�]?)?\\d{3,8}([-_－�?�]?\\d{3,8})?([-_－�?�]?\\d{1,7})?$)|(^0?1[35]\\d{9}$)" ;   
    /**  
     * 手机号码正则表达�?=^(13[0-9]|15[0|3|6|7|8|9]|18[8|9])\d{8}$  
     */  
    public static final String MOBILE ="^(13[0-9]|15[0|3|6|7|8|9]|18[8|9])\\d{8}$";   
  
    /**  
     * IP地址正则表达�? ((?:(?:25[0-5]|2[0-4]\\d|[01]?\\d?\\d)\\.){3}(?:25[0-5]|2[0-4]\\d|[01]?\\d?\\d))  
     */  
    ...
    /**  
     * Double正则表达�? ^-?([1-9]\d*\.\d*|0\.\d*[1-9]\d*|0?\.0+|0)$  
     */  
    public static final String  DOUBLE ="^-?([1-9]\\d*\\.\\d*|0\\.\\d*[1-9]\\d*|0?\\.0+|0)$";   
    /**  
     * 正Double正则表达�? >=0  ^[1-9]\d*\.\d*|0\.\d*[1-9]\d*|0?\.0+|0$�?  
     */  
    public static final String  DOUBLE_NEGATIVE ="^[1-9]\\d*\\.\\d*|0\\.\\d*[1-9]\\d*|0?\\.0+|0$";   
    /**  
     * 负Double正则表达�? <= 0  ^(-([1-9]\d*\.\d*|0\.\d*[1-9]\d*))|0?\.0+|0$  
     */  
    public static final String  DOUBLE_POSITIVE ="^(-([1-9]\\d*\\.\\d*|0\\.\\d*[1-9]\\d*))|0?\\.0+|0$";    
    /**  
     * 年龄正则表达�? ^(?:[1-9][0-9]?|1[01][0-9]|120)$ 匹配0-120�?  
     */  
    public static final String  AGE="^(?:[1-9][0-9]?|1[01][0-9]|120)$";   
    /**  
     * 邮编正则表达�?  [1-9]\d{5}(?!\d) 国内6位邮�?  
     */  
    ...
    /**  
     * 匹配由数字和26个英文字母组成的字符�? ^[A-Za-z0-9]+$   
     */  
    public static final String STR_ENG_NUM="^\\w+$";   
    /**  
     * 匹配�?26个英文字母组成的字符�?  ^[A-Za-z]+$  
     */  
...
//        System.out.println("pattern="+pattern);   
    ...
    /**  
     * 判断是不是科学计数法 如果�? 返回true  
     * 匹配科学计数 e或�?�E必须出现有且只有�?�? 结尾不含D  
     * 匹配模式可参考本类定义的 SCIENTIFIC_A，SCIENTIFIC_B,SCIENTIFIC_C,SCIENTIFIC_D  
     * 若判断为其他模式可调�? Regular(String str,String pattern)方法  
     * @param str 科学计数字符�?  
     * @return boolean  
     */  
	...
	public static void main(String[] args) {
		String html = escape("http://www.baidu.com");
